...
module.exports = "/cards.5fd3b7d4.hbs";
...
},{}],"js/card_list.js":[function(require,module,exports) {
"use strict";
...
var menuMarkup = (0, _cards.default)(_menu.default);
var refs = {
  cards: document.querySelector('#menu')
};
refs.cards.innerHTML = menuMarkup;
},{"../templates/cards.hbs":"templates/cards.hbs","../menu.json":"menu.json"}],"js/change_theme.js":[function(require,module,exports) {
var Theme = {
  LIGHT: 'light-theme',
  DARK: 'dark-theme'
};
...
var changeTheme = function changeTheme(evt) {
...
require("./js/card_list.js");

require("./js/change_theme.js");
},{"./js/card_list.js":"js/card_list.js","./js/change_theme.js":"js/change_theme.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
